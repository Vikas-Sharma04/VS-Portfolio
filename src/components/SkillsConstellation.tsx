...
const skillsData = [
  ...
  {
    category: "Frontend",
    skills: ["React.js", "Next.js", "Redux Toolkit", "Tailwind CSS", "Three.js", "GSAP", "Framer Motion"],
    color: "secondary",
  },
  {
    category: "Backend",
    skills: ["Node.js", "Express.js", "FastAPI", "Flask", "Socket.io", "Auth (JWT, OAuth2)", "REST APIs"],
    color: "accent",
  },
  {
    category: "Databases",
  ...
  },
  {
    ...
    skills: ["Git & GitHub", "Docker", "Postman", "Jupyter / Anaconda", "Vercel / Netlify / Render", "Linux / Bash"],
    color: "accent",
  },
];
